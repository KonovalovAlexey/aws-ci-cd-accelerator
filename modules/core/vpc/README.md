...
| Name | Source | Version |
|------|--------|------|
| <a name="module_security-group"></a> [security-group](#module\_security-group) | terraform-aws-modules/security-group/aws | 4.17.2 |
...
| <a name="input_nat_prefix_list_ids"></a> [nat\_prefix\_list\_ids](#input\_nat\_prefix\_list\_ids) | Prefix list ID with NAT IP | `list(string)` | `[]` | no |
...
| <a name="output_vpc_nat_security_group"></a> [vpc\_nat\_security\_group](#output\_vpc\_nat\_security\_group) | ======================== NAT Security Group =========================== |
