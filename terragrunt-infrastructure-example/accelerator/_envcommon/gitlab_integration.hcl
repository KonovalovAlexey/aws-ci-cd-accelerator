...
locals {
  ...
  parameter_vars = read_terragrunt_config(find_in_parent_folders("app_parameter_store.hcl"))
  ...
  base_source_url = "${get_path_to_repo_root()}//modules//core/aws_gitlab_integration/"
}
